...
export function WhatsAppFloat() {
  ...
  useEffect(() => {
    if (!isVisible) return
    const tooltipTimer = setTimeout(() => setIsTooltipVisible(true), 5000)
  ...
  const message = encodeURIComponent(
    "Hi, I'd like to book a consultation at Vernon Skin and Hair Clinic."
  )
  ...
  return (
    <div className="fixed bottom-20 right-4 z-40 lg:bottom-6 lg:right-6">
      ...
      <motion.a
        ...
        href={`https://wa.me/919100017567?text=${message}`}
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-green-600/30 transition-transform hover:scale-110 active:scale-95"
