...
export function PicoComparison() {
  ...
  return (
    <section className="border-y border-brand-100 bg-white py-20 lg:py-28">
          ...
          <div ref={headingRef}>
            ...
            <div className="mt-8 space-y-6">
              <motion.div
                ...
                className="rounded-xl border border-brand-100 p-5 transition-shadow hover:shadow-md"
              >
                <h3 className="flex items-center gap-2 text-base font-medium text-brand-900">
                ...
                <p className="mt-2 text-sm text-brand-500">
                  Fires in nanoseconds (10⁻⁹ seconds). Relies on <strong className="text-brand-700">photothermal</strong> energy
              ...
              <motion.div
                ...
                className="rounded-xl border-2 border-earth-200 bg-earth-50/30 p-5 transition-shadow hover:shadow-md hover:shadow-earth-100"
              >
                <h3 className="flex items-center gap-2 text-base font-medium text-brand-900">
                  <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-earth-100 text-xs font-bold text-earth-700">
                    NEW
                  </span>
                  Pico Laser (Picosecond) — Used at Vernon
                </h3>
                <p className="mt-2 text-sm text-brand-600">
                  Fires in picoseconds (10⁻¹² seconds) — <strong className="text-brand-800">1,000× faster</strong>.
                  The dominant mechanism shifts to <strong className="text-brand-800">photoacoustic</strong>:
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <span className="rounded bg-earth-100 px-2 py-0.5 text-xs text-earth-800">4–8 sessions</span>
                  <span className="rounded bg-earth-100 px-2 py-0.5 text-xs text-earth-800">Safest for Indian skin</span>
                  <span className="rounded bg-earth-100 px-2 py-0.5 text-xs text-earth-800">All ink colors</span>
                </div>
              </motion.div>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-brand-100">
                    <th className="px-4 py-3 text-left text-xs font-medium text-brand-400">
                      Parameter
                    </th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-red-500">
                      Q-Switch
                    </th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-earth-600">
                      Pico (Vernon)
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-brand-50 text-sm">
                  {tableRows.map((row, index) => (
                    ...
                    >
                      <td className="px-4 py-2.5 text-xs font-medium text-brand-700">
                        {row.param}
                      </td>
                      <td className="px-4 py-2.5 text-xs text-brand-500">
                        {row.old}
                      </td>
                      <td className="px-4 py-2.5 text-xs font-medium text-earth-700">
                        {row.new}
                      </td>
                    </motion.tr>
                  ))}
