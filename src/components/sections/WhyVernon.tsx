...
export function WhyVernon() {
  ...
  return (
    <section className="relative overflow-hidden py-24 lg:py-32">
      ...
      <div className="absolute -left-40 top-0 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-clinical-100/20 to-transparent blur-3xl" />
      <div className="absolute -right-40 bottom-0 h-[400px] w-[400px] rounded-full bg-gradient-to-bl from-vernon-100/15 to-transparent blur-3xl" />
...
function CardItem({
  ...
  return (
    <motion.div
      ...
      className="group h-full rounded-2xl border border-vernon-100 bg-white p-8 transition-all duration-300 hover:-translate-y-0.5 card-elevated"
    >
      {/* Icon */}
      <div
        className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl ${item.iconColor} transition-transform duration-300 group-hover:scale-105`}
      >
        {item.icon}
      </div>
